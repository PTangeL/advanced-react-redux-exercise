...
2. Checkout branch 01_solution_logger_middleware, in this branch there is an action in UsersContainer that dispatches a promise. Create a promise middleware to teach the store's dispatch how to understand promises.
